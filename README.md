...
```javascript
seq2multislice = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/slice-base-seq2multislice@v0.2.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/slice-base-seq2multislice/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/slice-base-seq2multislice/actions/workflows/test.yml?query=branch:v0.2.0
